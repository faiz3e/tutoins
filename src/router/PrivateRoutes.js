    ...
    <div>
        ...
        <Route {...rest} render={(props) => (
            isAuth === true
                ?
                <div>
                <header className="header-global" style={{backgroundColor:"#5e72e4"}}>
    <nav id="navbar-main" className="navbar navbar-main navbar-expand-lg navbar-light headroom">
        ...
        <div className="navbar-collapse collapse" id="navbar_global">
          ...
          <ul className="navbar-nav navbar-nav-hover align-items-lg-center">
            <li className="nav-item dropdown">
              <a href="#" className="nav-link" data-toggle="dropdown" href="#" role="button" style={{color:"white"}}>
          ...
          <ul className="navbar-nav align-items-lg-center ml-lg-auto">
            ...
            <li className="nav-item d-none d-lg-block ml-lg-4">
              <Link className="btn btn-neutral btn-icon" to={{
                    pathname:  '/publicHome'
                }}>
